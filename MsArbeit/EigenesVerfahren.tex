...
\lstinputlisting[language=Python, float=htpb, caption={Pseudocode für die Kontrolle der VBOs}, label=lst:VBOkontrolle, captionpos=b, keywordstyle=\bfseries\color{black}]{code/test.py}


Listing \ref{lst:VBOkontrolle} zeigt ...
\lstinputlisting[language=Python, style=customc, float=htpb, caption={Pseudocode für die Kontrolle der VBOs}, label=lst:VBOkontrolle, captionpos=b, keywordstyle=\bfseries\color{black}]{code/test.py}


Listing \ref{lst:VBOkontrolle} zeigt ...
\lstinputlisting[language=Python, style=customc, float=htpb, caption={Pseudocode für die Kontrolle der VBOs}, label=lst:VBOkontrolle, captionpos=b, keywordstyle=\bfseries\color{black}]{code/test2.py}
